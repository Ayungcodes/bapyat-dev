    ...
    "
      ...
      <div className="flex justify-center mt-8 md:mt-12">
        <a
          ...
          target="_blank"
          className={`py-1 px-10 md:text-xl transition duration-500 cursor-pointer rounded-4xl bg-yellow-600 text-[#0a0a0a] font-[Sora] font-bold text-sm hover:opacity-80 hover:scale-95 hover:bg-[#ffff]`}
        >
          View All
        </a>
      </div>
