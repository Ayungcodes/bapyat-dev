function Hero({ state, welcomeRef, contactRef, projectsRef, scrollToSection }) {
  return (
    <section
      ref={welcomeRef}
      ...
      <div className="relative z-10 max-w-3xl w-full flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-white/75 max-w-md text-[15px] md:text-base leading-relaxed">
            I build fast, responsive web apps that help businesses grow and
            stand out online.
          </p>
        ...
        {/* second item */}
        {/* <div className="flex flex-col justify-center items-center gap-[70px] uppercase text-sm text-white/50 font-medium tracking-wide">
          <a href="#" className="-rotate-90 block duration-300 transition-all hover:text-white">linkedin</a>
          <a href="#" className="-rotate-90 block duration-300 transition-all hover:text-white">github</a>
          <a href="#" className="-rotate-90 block duration-300 transition-all hover:text-white">instagram</a>
          <a href="#" className="-rotate-90 block duration-300 transition-all hover:text-white">twitter</a>
          <a href="#" className="-rotate-90 block duration-300 transition-all hover:text-white">dribble</a>
        </div> */}
