...
const NavBar = ({ scrollToSection, refs, state, setState, toggleNav }) => {
  ...
  return (
    <nav
      className={`navbar py-4 w-full flex items-center fixed backdrop-blur-sm z-9999`}
    >
      <div className="md:px-5 md:py-3 lg:px-24 flex items-center justify-between px-4 w-screen">
        {/* logo */}
        <div className="flex justify-center items-center gap-2">
          <button
            ...
            ref={logoRef}
            className="
    font-semibold text-lg md:text-2xl tracking-wider
    cursor-pointer z-50
  ...
  "
          >
            <span
              className="
      text-white-90 duration-300 transition-all hover:text-yellow-600
    "
            >
              Gaius.
            </span>
      ...
      >
        <div className="absolute top-0 right-0 lg:hidden w-full h-full flex flex-col justify-center px-6">
          <div className="flex flex-row w-full justify-around items-start mx-auto space-x-10">
            ...
            {/* social links */}
            <div className="flex flex-col items-start space-y-7 font-semibold">
              <h3 className="text-[16px] md:text-[18px] text-gray-400">
                Socials
              </h3>
              {[
                {
          ...
          <div className="absolute bottom-0 flex items-center justify-center w-full h-10 p-4 text-[14px] md:text-xl">
            <h2>
              Crafted by{" "}
              <span className="text-yellow-500">Gaius Emmanuel.</span>
            </h2>
          </div>
        </div>
      </div>
